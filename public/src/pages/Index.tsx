...
const Index = () => {
  ...
  return (
    <SiteLayout>
      <Helmet>
        <title>RangoStore – Trendy Marketplace</title>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <Link key={c.slug} to={`/category/${c.slug}`} className="group border rounded-lg p-5 hover:bg-secondary transition-colors">
              <div className="h-20 rounded bg-gradient-to-br from-primary/20 to-primary/40 group-hover:from-primary/30 group-hover:to-primary/50 transition-all" />
